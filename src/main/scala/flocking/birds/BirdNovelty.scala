...
import flocking.datatypes.{Angle, Heading, Point}
import flocking.engine.Model
import scala.math._
import scala.collection._
import flocking.environment.Environment
...
object BirdNovelty {
  def apply(_p: Point, _heading: Heading): BirdNovelty =
    new BirdNovelty {
